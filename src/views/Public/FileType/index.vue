...
<script>
    import {fileListAll} from "@/api/public/index.js"
    ...
    export default {
        ...
        methods: {
            ...
            createFold(value) {
                ...
                createFold({folderName: value, diskType: PUBLIC_DISK_ID, diskId: this.diskId, id: this.foldId === '0'? undefined: this.foldId}).then(() => {
                    this.fetchFiles()
